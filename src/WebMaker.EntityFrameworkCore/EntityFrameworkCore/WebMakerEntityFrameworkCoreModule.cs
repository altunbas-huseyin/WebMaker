...
public class WebMakerEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<WebMakerDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
                 ...
                 * See also WebMakerDbContextFactory for EF Core tooling. */
